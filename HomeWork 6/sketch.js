...
let startCountButton = document.getElementById('start'),
    ...
    budgetValueBlock = document.getElementsByClassName('budget-value')[0],
    daybudgetValueBlock = document.getElementsByClassName('daybudget-value')[0],
    levelValueBlock = document.getElementsByClassName('level-value')[0],
    expensesValueBlock = document.getElementsByClassName('expenses-value')[0],
    optionalexpensesValueBlock = document.getElementsByClassName('optionalexpenses-value')[0],
    incomeValueBlock = document.getElementsByClassName('income-value')[0],
    monthsavingsValueBlock = document.getElementsByClassName('monthsavings-value')[0],
    yearsavingsValueBlock = document.getElementsByClassName('yearsavings-value')[0],
    ...
    otherInput[0] = document.querySelector('#income'),
    otherInput[1] = document.querySelector('#savings'),
    otherInput[2] = document.querySelector('#sum');
    otherInput[3] = document.querySelector('#percent');
    otherInput[4] = document.querySelector('.year-value');
    otherInput[5] = document.querySelector('.month-value');
    otherInput[6] = document.querySelector('.day-value');
